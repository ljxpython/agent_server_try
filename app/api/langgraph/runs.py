...
async def stream_run(request: Request, payload: dict[str, Any] = Body(...)) -> StreamingResponse:
    """
...
async def update_cron(request: Request, cron_id: str, payload: dict[str, Any] = Body(...)) -> Any:
    """
    更新指定 cron 的可变字段。
