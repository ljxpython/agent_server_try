...
@router.post("")
async def create_assistant(request: Request, payload: dict[str, Any] = Body(...)) -> Any:
    """
    创建 assistant 资源。
...
@router.post("/search")
async def search_assistants(request: Request, payload: dict[str, Any] = Body(...)) -> Any:
    """
    按条件检索 assistants 列表。
...
@router.post("/count")
async def count_assistants(request: Request, payload: dict[str, Any] = Body(...)) -> Any:
    """
